...
from event_board.cli import main
from event_board.models import Note, ProjectState, Task
from event_board.cli import demo_state
from event_board.storage import load_state, save_state
from event_board.models import generate_short_id
from event_board.validation import normalize_tags, require_text, validate_task_status
from event_board.services import (
    create_note,
    list_notes,
    get_note,
    update_note,
